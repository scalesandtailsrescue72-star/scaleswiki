...
export const ballPythonLessons: LessonExtended[] = [
  {
    ...
    quizQuestions: [
      {
        question:
          "What is the primary purpose of Ball Python 101?",
        options: [
      ...
      {
        question:
          "Successful reptile keeping begins with...",
        options: [
...

  {
    ...
    description:
      "Understand where Ball Pythons come from and how their natural habitat influences captive care.",
    duration: "10 min",
    difficulty: "Beginner",
