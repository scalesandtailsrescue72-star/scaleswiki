            ...
            return (
              ...
              >
                ...
                <div className="mt-8 space-y-2 text-sm text-gray-400">
                  <p>📚 Lessons: {course.stats.lessons}</p>
                  <p>⏱ Estimated Time: {course.stats.estimatedTime}</p>
                  <p>Status: {status}</p>
                </div>
                ...
                <div className="mt-10">
                  {status === "Available" ? (
                    ...
                    <button
                      disabled
                      className="cursor-not-allowed rounded-xl bg-gray-700 px-6 py-3 text-gray-400"
                    >
                      Coming Soon
                    </button>
                  )}
