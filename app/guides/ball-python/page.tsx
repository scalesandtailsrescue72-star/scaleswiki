...
const chapters = [
  ...
  { title: "Selecting a Healthy Ball Python", href: "/content/guides/ball-python/05-selecting-a-healthy-ball-python.md" },
  { title: "Quarantine and Biosecurity", href: "/content/guides/ball-python/06-quarantine-biosecurity.md" },
  { title: "Enclosure Design", href: "/content/guides/ball-python/07-enclosure-design.md" },
  { title: "Illustrations", href: "/content/guides/ball-python/illustrations.md" },
  { title: "Worksheets", href: "/content/guides/ball-python/worksheets.md" },
  { title: "References", href: "/content/guides/ball-python/references.md" },
];
  ...
  return (
    <main className="min-h-screen bg-[#08120D] text-[#F5F5F5]">
      <section className="mx-auto max-w-6xl px-6 py-24 lg:px-8">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#2ECC71]">Guide</p>
        ...
        <p className="mt-4 max-w-2xl text-lg text-[#9CA3AF]">
          A structured, beginner-friendly guide covering setup, care, and health considerations.
        </p>
